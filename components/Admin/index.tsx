...
/*     const {
        ...
        // Log the IPFS hash if upload succeeded
           ...
           /*  // Call the smart contract function with the uploaded IPFS CID
            writeContract_create({
                ...
                abi: AcidTestABI,
                functionName: 'create',
                args: [formData.startDate, formData.endDate, BigInt(formData.price), upload.IpfsHash] // Use the IPFS hash from the upload response
            }); */
    ...
    const handleMockUpload = async () => {
        ...
        const file = new File([JSON.stringify(mockedMetadata)], "mocked_metadata.json", { type: "application/json" });
        ...
        <div className="min-h-screen bg-black text-white font-mono p-6 flex flex-col items-center w-full">
            ...
            {showForm && (
                <form onSubmit={handleSubmit} className="w-full max-w-md space-y-4 mt-8">
                    ...
                    <div>
                        <label htmlFor="startDate" className="block mb-1">Start Date <CalendarIcon /></label>
                        <input
                            type="datetime-local"
                            name="startDate"
                    ...
                    <div>
                        <label htmlFor="endDate" className="block mb-1">End Date <CalendarIcon /></label>
                        <input
                            type="datetime-local"
                            name="endDate"
                    ...
                    <div>
                        <label htmlFor="price" className="block mb-1">Price <DollarSignIcon /></label>
                        <input
                            type="number"
                            name="price"
                    ...
                    <div>
                        <label htmlFor="audioFile" className="block mb-1">Audio File <FileIcon /></label>
                        <input
                            type="file"
                            name="audioFile"
                    ...
                    <div>
                        <label htmlFor="coverImage" className="block mb-1">Cover Image <FileIcon /></label>
                        <input
                            type="file"
                            name="coverImage"
                            onChange={handleFileChange}
                    ...
                    <button type="submit" className="w-full p-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg">
                        Confirm
                    </button>
                </form>
            )}
